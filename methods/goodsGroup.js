...
async function getShopList(XMLDir, project) {
    ...
    try {
        const shopList = await _readXMLHeader('shop.xml', XMLDir, project);
        const iapProductList = await _readXMLHeader('iapProduct.xml', XMLDir, project);
...
async function getShopListHash(XMLDir, project) {
    ...
    try {
        const shop = await _readXMLFile('shop.xml', XMLDir, project);
...
async function getIapProductHashHash(XMLDir, project) {
    ...
    try {
        const iapProduct = await _readXMLFile('iapProduct.xml', XMLDir, project);
